...
import 'package:stream_agram/controllers/hearticonstate.dart';
...
class cardSugerencias extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final Heart = Provider.of<HeartIconState>(context);
    return Padding(
